...
class AppColor {
  static Color homePageBg = const Color(0xFFfbfcff);
  ...
  static Color homePageContainerTxtSm = const Color(0xFFf4f5fd);
  static Color homePageContainerTxtBig = const Color(0xFFffffff);
